...
public class Main {
    ...
    public static void main(String[] args) {
        String[] nomes  = {"Fácil", "Média", "Difícil"};
        String[] paths  = {"instancia_facil.json", "instancia_media.json", "instancia_dificil.json"};
        ...
        for (int i = 0; i < paths.length; i++) {
            ...
            try {
                ...
                System.out.printf("⏱️  Tempo de execução: %d ms%n", r.tempoExecucaoMs);
